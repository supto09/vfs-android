...
Lightweight project index files live in `docs/context/`. To minimize token usage, open these only when needed, and avoid loading both unless required for a task.
